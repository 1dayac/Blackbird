 ...
 * @param b          the buffer
 */
void mm_tbuf_destroy(mm_tbuf_t2 *b);

void *mm_tbuf_get_km(mm_tbuf_t2 *b);
 ...
 */
mm_reg1_t2 *mm_map(const mm_idx_t2 *mi, int l_seq, const char *seq, int *n_regs, mm_tbuf_t2 *b, const mm_mapopt_t2 *opt, const char *name);

void mm_map_frag(const mm_idx_t2 *mi, int n_segs, const int *qlens, const char **seqs, int *n_regs, mm_reg1_t2 **regs, mm_tbuf_t2 *b, const mm_mapopt_t2 *opt, const char *qname);
