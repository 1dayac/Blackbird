...
static inline int mm_get_hplen_back(const mm_idx_t2 *mi, uint32_t rid, uint32_t x)
{
...
static inline void mm_adjust_minier(const mm_idx_t2 *mi, uint8_t *const qseq0[2], mm128_t *a, int32_t *r, int32_t *q)
{
	if (mi->flag & MM_I_HPC) {
